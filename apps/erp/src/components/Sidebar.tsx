...
const MENU = [
  ...
  { path: '/sales-invoices', label: 'Satis Faturalari', icon: FileText },
  { path: '/customers', label: 'Musteriler', icon: Users },
  { group: 'Stok & Depo' },
  { path: '/products', label: 'Urunler', icon: Package },
  { path: '/purchase-receipts', label: 'Alis Irsaliyeleri', icon: FileText },
  { path: '/sales-deliveries', label: 'Satis Irsaliyeleri', icon: FileText },
  { path: '/transfer-orders', label: 'Transfer Emirleri', icon: Truck },
  { path: '/stock-counts', label: 'Sayim Fisleri', icon: Warehouse },
  ...
  { path: '/purchase-invoices', label: 'Alis Faturalari', icon: FileText },
